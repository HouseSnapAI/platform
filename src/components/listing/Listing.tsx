...
const Listing = ({listing, email, userInfo, setUserInfo, onHover}: {
  listing: ListingType, 
  ...
  return (
    <>
      <BlinkingBox 
        className={`group flex flex-col items-center w-min justify-center p-3 border-[1px] border-[#393939] rounded-sm ${isHovering ? 'blink-rapidly' : ''}`}
        sx={{
